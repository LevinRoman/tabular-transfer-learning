...
for data in ${StringArray[@]}; do
    #copy the config
    python scripts/replace_dataset_id_in_config.py --new_id $data --old_id 1483 --model resnet --do_destructive_danger
    ...
    #mlp head
    python bin/resnet.py output/${data}/resnet/multiclass_transfer/downstream/data_frac_250/transfer/mlp_head_fine_tune/default/0.toml -f
    #full
    ...
    #full mlp head
    python bin/resnet.py output/${data}/resnet/multiclass_transfer/downstream/data_frac_250/transfer/full_mlp_head_fine_tune/default/0.toml -f
    #full big lr
    ...
    python bin/resnet.py output/${data}/resnet/multiclass_transfer/downstream/data_frac_250/transfer/full_mlp_head_fine_tune_big_lr/default/0.toml -f
    ...
    #mlp head
    python bin/resnet.py output/${data}/resnet/multiclass_transfer/downstream/data_frac_50/transfer/mlp_head_fine_tune/default/0.toml -f
    #full
    ...
    #full mlp head
    python bin/resnet.py output/${data}/resnet/multiclass_transfer/downstream/data_frac_50/transfer/full_mlp_head_fine_tune/default/0.toml -f
    #full big lr
    ...
    #full mlp head big lr
    python bin/resnet.py output/${data}/resnet/multiclass_transfer/downstream/data_frac_50/transfer/full_mlp_head_fine_tune_big_lr/default/0.toml -f
    ...
    #mlp head
    python bin/resnet.py output/${data}/resnet/multiclass_transfer/downstream/data_frac_10/transfer/mlp_head_fine_tune/default/0.toml -f
    #full
    ...
    #full mlp head
    python bin/resnet.py output/${data}/resnet/multiclass_transfer/downstream/data_frac_10/transfer/full_mlp_head_fine_tune/default/0.toml -f
    #full big lr
    ...
    #full mlp head big lr
    python bin/resnet.py output/${data}/resnet/multiclass_transfer/downstream/data_frac_10/transfer/full_mlp_head_fine_tune_big_lr/default/0.toml -f
    ...
    #mlp head
    python bin/resnet.py output/${data}/resnet/multiclass_transfer/downstream/data_frac_5/transfer/mlp_head_fine_tune/default/0.toml -f
    #full
    ...
    #full mlp head
    python bin/resnet.py output/${data}/resnet/multiclass_transfer/downstream/data_frac_5/transfer/full_mlp_head_fine_tune/default/0.toml -f
    #full big lr
    ...
    #full mlp head big lr
    python bin/resnet.py output/${data}/resnet/multiclass_transfer/downstream/data_frac_5/transfer/full_mlp_head_fine_tune_big_lr/default/0.toml -f
    ...
    #mlp head
    python bin/resnet.py output/${data}/resnet/multiclass_transfer/downstream/data_frac_2/transfer/mlp_head_fine_tune/default/0.toml -f
    #full
    ...
    #full mlp head
    python bin/resnet.py output/${data}/resnet/multiclass_transfer/downstream/data_frac_2/transfer/full_mlp_head_fine_tune/default/0.toml -f
    #full big lr
    ...
    #full mlp head big lr
    python bin/resnet.py output/${data}/resnet/multiclass_transfer/downstream/data_frac_2/transfer/full_mlp_head_fine_tune_big_lr/default/0.toml -f

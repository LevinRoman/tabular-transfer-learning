...
parser.add_argument('--transfer_setups', default=['head_fine_tune', 'mlp_head_fine_tune', 'full_fine_tune', 'full_mlp_head_fine_tune', 'full_mlp_head_fine_tune_big_lr', 'full_fine_tune_big_lr'], type=str, nargs='+')

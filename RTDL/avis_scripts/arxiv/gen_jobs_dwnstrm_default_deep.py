...
for model in models:
    for dset_id in dset_ids:
        ...
        for seed in range(seeds):
            ...
            launch_str = f"python -W ignore bin/{model}.py {out_dir}/{dset_id}_supervised_pretraining_{model}_seed{seed}.toml -f \n"
            ...
            for sample_num in sample_nums:
                ...
                launch_str = launch_str + f"python -W ignore bin/{model}.py {out_dir}/{dset_id}_downstream_{sample_num}samples_fromscratch_{model}_seed{seed}.toml -f \n"
                ...
                toml_dict["training"]["patience"] = 1e5
                toml_dict["training"]["lr"] = 1e-4
                toml_dict["transfer"]["checkpoint_path"] = os.path.join(out_dir, f"{dset_id}_supervised_pretraining_{model}_seed{seed}/checkpoint.pt")
                toml_dict["transfer"]["downstream_samples_per_class"] = sample_num
                ...
                launch_str = launch_str + f"python -W ignore bin/{model}.py {out_dir}/{dset_id}_downstream_{sample_num}samples_random_extractor_{model}_seed{seed}.toml -f \n"
                ...
                with open(os.path.join(out_dir, f"{dset_id}_downstream_{sample_num}samples_tuned_linear_head_from_supervised_pretrain_{model}_seed{seed}.toml"), "w") as fh:
                    toml.dump(toml_dict, fh)

                launch_str = launch_str + f"python -W ignore bin/{model}.py {out_dir}/{dset_id}_downstream_{sample_num}samples_tuned_linear_head_from_supervised_pretrain_{model}_seed{seed}.toml -f \n"
                ...
                with open(os.path.join(out_dir,
                          ...
                          "w") as fh:
                    toml.dump(toml_dict, fh)
                launch_str = launch_str + f"python -W ignore bin/{model}.py {out_dir}/{dset_id}_downstream_{sample_num}samples_tuned_mlp_head_from_supervised_pretrain_{model}_seed{seed}.toml -f \n"
                ...
                launch_str = launch_str + f"python -W ignore bin/{model}.py {out_dir}/{dset_id}_downstream_{sample_num}samples_linear_head_tuned_full_from_supervised_pretrain_{model}_seed{seed}.toml -f \n"
                ...
                launch_str = launch_str + f"python -W ignore bin/{model}.py {out_dir}/{dset_id}_downstream_{sample_num}samples_mlp_head_tuned_full_from_supervised_pretrain_{model}_seed{seed}.toml -f \n"
            ...
            os.makedirs('../RTDL/launch/default_deep_jobs', exist_ok=True)
            with open(f"../RTDL/launch/default_deep_jobs/{dset_id}_{model}_exp_seed{seed}.sh", "w") as fh:
                fh.write(launch_str)
"""MIMIC catboost jobs tuned with CV"""
import toml
import os
import numpy as np
...
n_estimators = [100]
out_dir = f"output/tuned_dwnstrm_catboost_100trees"
            ...
            for seed in range(seeds):
                ...
                for sample_num in sample_nums:
                    for n_est in n_estimators:
                        ...
                        toml_dict["transfer"]['use_optuna_CV'] = True
                        with open(os.path.join(out_dir,
                ...
                os.makedirs('launch/tuned_catboost_jobs_100trees', exist_ok=True)
                with open(f"launch/tuned_catboost_jobs_100trees/{dset_id}{downstream_target}_{model}_exp_seed{seed}.sh", "w") as fh:
                    fh.write(launch_str)